...
var GUI = (function(){
    ...
    var initScroll      = function(){
        ...
        win.scroll(function(event){
            ...
            if(position > _pos){
                top.addClass('animate_fixed');
                // menu.addClass('animate_fixed');
                // mb.css('margin-top', '98px');

                position = _pos;
                if(position < 150){
                    top.removeClass('animate_fixed');
                    // menu.removeClass('animate_fixed');
                    $('.block').css('height', '0px !important');
                    // mb.css('margin-top', '0');
                }
            } else{
                position = _pos;
    ...
    var menu_mobile = function(){
        ...
        m_nav_btn.on('click', function (event) {
            ...
            $("body").toggleClass('overflow-hidden opacity');
        });
        ...
        win.click(function(e) {
            if(win.width() < 992 && m_nav.has(e.target).length == 0 && !m_nav.is(e.target)){
                ...
                $("body").removeClass('overflow-hidden opacity');
...
$(document).ready(function() {
    $('.bgloading').delay(700).fadeOut(500); 
});
